...
class TextField_old(RawField):
    ...
    def __init__(self, use_vocab=True, init_token=None, eos_token=None, fix_length=None, dtype=torch.long,
        ...
        super(TextField_old, self).__init__(preprocessing, postprocessing)
    ...
    def build_vocab(self, *args, **kwargs):
        ...
        for data in sources:
            with tqdm(desc='Build Vocabulary', unit='it', total=len(data)) as pbar:
